...
#define kWidthScale  (kScreenW / 375)
 ...
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor rgba(181,181,181,1)
 ...
 *  单个圆的半径
 */
#define CircleRadius 40 * kWidthScale
 ...
 *  普通状态下文字提示的颜色
 */
#define textColorNormalState  rgba(28,28,28,1)
 ...
 *  绘制解锁界面准备好时，提示文字
 */
#define gestureTextBeforeSet @"设置您的解锁图案"

/**
 *  设置时，连线个数少，提示文字
 */
#define gestureTextConnectLess @"最少连接5个点，请重新输入"
