...
class Utils{
    ...
    {
        RKDropdownAlert.title(title, backgroundColor: kNavigationBarColor, textColor: UIColor.white, time: 1)
//         RKDropdownAlert.title(title, time: 1)
    }
    
    static func showTip(_ view: UIView, errMsg: String) {
        RKDropdownAlert.title(errMsg, backgroundColor: kNavigationBarColor, textColor: UIColor.white, time: 1)
